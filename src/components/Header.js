            ...
            <div className="flex flex-stretch items-center">
              ...
              <div className="w-auto">
                ...
                >
                  ...
                  <li className="mx-3 py-6 md:py-0">
                    <NavLink className={`text-black ${mode === 'light' ? 'md:text-white' : 'md:text-black'} hover:underline`} to="/profile">Profile</NavLink>
                  </li>
                </ul>
              </div>
              <div className="w-auto">
                <ul className="items-center flex">
                  ...
                  <li className="ml-6">
                    <NavLink
                      id="header-cart"
                      className={`text-black ${mode === 'light' ? 'md:text-white' : 'md:text-black'} flex items-center justify-center w-8 h-8 text-black`}
                      to="/cart"
                    >
                      <svg
                        className="fill-current"
